...
%ALTERED BY PETE ATTAYEK 12/17/15
...
%Gaussian kernel modified by Pete
if (nargin < 3)
    filt = (fspecial('gaussian', 3,1)); %if needed modify the filter according to the expected peaks sizes
end
